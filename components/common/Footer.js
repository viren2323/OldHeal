...
export default function Footer() {
    return ( <
        ...
        <
        b > Address: < /b> C252 OLD NO 252B F/F
        BLOCK - C, NEW ASHOK NAGAR, EAST DELHI, Delhi, PIN - 110096 < br / >
        <
        b > Email: < /b> info@toptrove.org<br/ > < b > Mobile: < /b> +919649049912 < /
        div > <
